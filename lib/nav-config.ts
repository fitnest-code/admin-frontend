...
export const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'odenisler',    label: 'Ödənişlər',      icon: CreditCard,      href: '/odenisler'     },
  { key: 'subscriptions',label: 'Abunəlik',       icon: BadgeCheck,      href: '/subscriptions' },
  { key: 'hesabatlar',   label: 'Hesabatlar',     icon: BarChart2,       href: '/hesabatlar'    },
  { key: 'diet',         label: 'Diet',           icon: Salad,           href: '/diet'          },
  { key: 'mesq',         label: 'Məşq',           icon: Dumbbell,        href: '/mesq'          },
  { key: 'omnichannel',  label: 'Omnichannel',    icon: MessageSquare,   href: '/omnichannel'   },
  { key: 'stores',       label: 'Mağazalar',      icon: Store,           href: '/stores'        },
  { key: 'reviews',      label: 'Reytinqlər',     icon: Star,            href: '/reviews'       },
  { key: 'tenzimlemeler',label: 'Tənzimləmələr', icon: Settings,        href: '/settings'      },
]
